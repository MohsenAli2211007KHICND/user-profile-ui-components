                ...
                return (
                  <tr key={item.id}>
                    {Object.keys(item).map((it) => {
                      if (it !== "userId" && it !== "id")
                        if (!item[it]) return <td>---</td>;
                        else return <td>{item[it]}</td>;
                    })}
                    <td>
                      <Popconfirm
          ...
          <form className={styles.formPersonalInfo} onSubmit={onSubmit}>
            ...
            <table className={styles.formTable}>
              <tr>
                ...
                <td>
                  <InputField
                    ...
                    handler={handleTitle}
                    type="text"
                    placeholder="Title (example Pre-Med, BSCS etc.)"
                    pattern="[a-zA-Z ]*"
                    className={styles.fullSize}
                    required="required"
                  />
              ...
              <tr>
                ...
                <td>
                  <InputField
                    disabled={disGradDate}
                    value={graduationDate}
                    handler={handleGraduationDate}
                    type="date"
                    placeholder=""
                    className={styles.graduationDate}
                    required="required"
                  />
                </td>
                <td style={{ textAlign: "right" }}>
              ...
              <tr>
                ...
                <td colSpan="3">
                  <TextArea
                    value={fypThesis}
                    handler={handleFypthesis}
                    rows="5"
                    placeholder="Final Year Project or Thesis (If applicable)"
